...
from aws_lambda_builders.workflows.rust_cargo.utils import OSUtils


class TestOSUtils(TestCase):
    def test_popen_runs_a_process_and_returns_outcome(self):
        cwd_py = os.path.join(os.path.dirname(__file__), "..", "..", "..", "functional", "testdata", "cwd.py")
    ...
    def test_popen_can_accept_cwd(self):
        testdata_dir = os.path.join(os.path.dirname(__file__), "..", "..", "..", "functional", "testdata")
        p = OSUtils().popen(
