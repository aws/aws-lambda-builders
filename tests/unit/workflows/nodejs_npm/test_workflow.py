...
class TestNodejsNpmWorkflow(TestCase):
    ...
    def test_workflow_sets_up_npm_actions_without_download_dependencies_with_dependencies_dir_with_bundler(self):
        self.osutils.parse_json.side_effect = [{"aws_sam": {"bundler": "esbuild"}}]
        self.osutils.file_exists.side_effect = [True, False, True]
    ...
    def test_workflow_sets_up_npm_actions_with_download_dependencies_and_dependencies_dir_with_bundler(self):
        self.osutils.parse_json.side_effect = [{"aws_sam": {"bundler": "esbuild"}}]
        self.osutils.file_exists.side_effect = [True, False, True]
    ...
    def test_workflow_sets_up_npm_actions_without_download_dependencies_and_without_dependencies_dir_with_bundler(self):
        self.osutils.parse_json.side_effect = [{"aws_sam": {"bundler": "esbuild"}}]
        self.osutils.file_exists.side_effect = [True, False, True]
    ...
    def test_workflow_sets_up_npm_actions_without_combine_dependencies_with_bundler(self):
        self.osutils.parse_json.side_effect = [{"aws_sam": {"bundler": "esbuild"}}]
        self.osutils.file_exists.side_effect = [True, False, True, True]
