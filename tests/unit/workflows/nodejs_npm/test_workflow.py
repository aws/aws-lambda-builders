...
class TestNodejsNpmWorkflow(TestCase):
    ...
    def test_workflow_sets_up_npm_actions_with_download_dependencies_without_dependencies_dir(self):
        ...
        self.osutils_mock.file_exists.side_effect = [True, False, False]
    ...
    def test_workflow_sets_up_npm_actions_with_ci_if_lockfile_exists(self, package_lock_exists, shrinkwrap_exists):

        self.osutils_mock.file_exists.side_effect = [True, package_lock_exists, shrinkwrap_exists]
